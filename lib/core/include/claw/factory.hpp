...
namespace claw
{
  namespace pattern
  {
     ...
     * \author Julien Jorge
     */
    class bad_type_identifier : public exception
    {
    public:
      /**
       * \brief Constructor.
    ...
    /**
     * \brief The design pattern of the factory allow to dynamically
     * instanciate classes of various types given an identifier of this type.
     *
     * \b Template \b parameters:
     * - \a BaseClass A base class for all classes instanciated by this
     * factory.
...
#ifdef CLAW_FACTORY_IS_SINGLETON
    class factory : public basic_singleton<factory<BaseClass, IdentifierType> >
#else
    class factory
#endif
    {
    private:
      /**
       * \brief A class creator is an object that allocate a given type. This
       * is the base class for all class creators.
       */
      ...
      class class_creator : public class_creator_base
      {
      public:
