...
/**
 * \file iterator.hpp
 * \brief Some special kind of iterators. As an example: iterator on the keys
 * of a map. \author Julien Jorge
 */
...
namespace claw
{
  ...
  /**
   * \brief Base class for wrapped iterators, specialized for forward
   * iterators. \author Julien Jorge
   */
  template <typename Value, typename Iterator, typename Function>
  class wrapped_iterator_by_category<std::forward_iterator_tag, Value,
                                     Iterator, Function>
  {
  public:
    ...
    typedef wrapped_iterator_by_category<std::forward_iterator_tag, Value,
                                         Iterator, Function>
        self_type;
  ...
  public:
    ...
    wrapped_iterator_by_category(
      ...
      : m_it(that.get_iterator())
      , m_fun(that.get_function())
    {}
   ...
   */
  template <typename Value, typename Iterator, typename Function>
  class wrapped_iterator_by_category<std::bidirectional_iterator_tag, Value,
                                     Iterator, Function>
  {
  public:
    typedef typename std::iterator_traits<Iterator>::difference_type
    ...
    typedef wrapped_iterator_by_category<std::bidirectional_iterator_tag,
   ...
   */
  template <typename Value, typename Iterator, typename Function>
  class wrapped_iterator_by_category<std::random_access_iterator_tag, Value,
                                     Iterator, Function>
  {
  public:
    typedef typename std::iterator_traits<Iterator>::difference_type
    ...
    typedef wrapped_iterator_by_category<std::random_access_iterator_tag,
                                         Value, Iterator, Function>
        self_type;
  ...
  public:
    ...
    wrapped_iterator_by_category(
        const wrapped_iterator_by_category<std::random_access_iterator_tag, V,
                                           I, Function>& that)
      : m_it(that.m_it)
      , m_fun(that.m_fun)
    {}
  ...
  template <typename Value, typename Iterator, typename Function>
  wrapped_iterator_by_category<std::random_access_iterator_tag, Value,
                               Iterator, Function>
  operator+(int n,
            const wrapped_iterator_by_category<std::random_access_iterator_tag,
                                               Value, Iterator, Function>& it)
  {
    return it + n;
  }
