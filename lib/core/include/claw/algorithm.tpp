...
UnaryFunction claw::inplace_for_each(InputIterator first, InputIterator last,
                                     UnaryFunction f)
{
...
ForwardIterator1
claw::find_first_not_of(ForwardIterator1 first1, ForwardIterator1 last1,
 ...
 * (\a e2_first, \a e2_last), the latter will be completed by repeating its
 * last element.
 *
 * \b Example :
 * <tt>
...
std::size_t claw::replace(ForwardIterator1 first, ForwardIterator1 last,
