...
/**
 * \file claw.hpp
 * \brief The purpose of this file is to document the namespaces of the
 * library. \author Julien Jorge
 */
...
namespace claw
{
  ...
  /**
   * \brief Tweeners interpolate the intermediate values between two given
   *        reference values using various equations.
   * \sa \ref tweeners
   */
  namespace tween
  {}
