...
namespace claw
{
  ...
  {
    /**
     * \brief A class representing a rectangle by his x,y coordinates, width
     * and height.
     *
     * This class considers that the y-axis increases from the top to the
     * bottom (like a screen).
     *
     * \author Julien Jorge
     */
    template <class T>
