...
namespace claw
{
  ...
  public:
    ...
    public:
      ...
      std::string make_assignment(const std::string& key,
  ...
  public:
    ...
    typedef claw::wrapped_iterator<
        const file_content::key_type, file_content::const_iterator,
        const_pair_first<file_content::value_type> >::iterator_type
        const_file_iterator;

    /** \brief Iterator on the fields of a section. */
    typedef claw::wrapped_iterator<
        const section_content::key_type, section_content::const_iterator,
        const_pair_first<section_content::value_type> >::iterator_type
        const_section_iterator;

    /**
     * \brief This class is an iterator on the values set for a same field
     * name.
     */
  ...
  public:
    configuration_file();
    configuration_file(std::istream& is, const syntax_description& syntax
                                         = syntax_description());
    ...
    const std::string& operator()(const std::string& section,
    ...
    void set_value(const std::string& section, const std::string& field,
                   const std::string& val);
    void set_value(const std::string& field, const std::string& val);

    void add_value(const std::string& section, const std::string& field,
                   const std::string& val);
    void add_value(const std::string& field, const std::string& val);

    void clear_section(const std::string& section);

    const_field_iterator field_begin(const std::string& section,
                                     const std::string& field) const;
    const_field_iterator field_end(const std::string& section,
                                   const std::string& field) const;
  ...
  private:
    ...
    void escape_char(char escaped, const syntax_description& syntax,
                     std::string& str) const;

    void save_section_content(const section_content& c, std::ostream& os,
