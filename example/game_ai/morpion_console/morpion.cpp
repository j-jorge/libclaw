...
/**
 * Calcule la supériorité du symbole de l'ordinateur sur son contraire sur
 * trois cases. \param a indice de la première case. \param b indice de la
 * deuxième case. \param c indice de la troisième case.
 */
