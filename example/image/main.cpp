...
void save_bitmap(const claw::graphic::image& img, const std::string& filename)
{
...
void save_pcx(const claw::graphic::image& img, const std::string& filename)
{
...
void save_png(const claw::graphic::image& img, const std::string& filename)
{
  ...
  save_png(img, filename, claw::graphic::png::writer::options::no_compression,
  ...
  save_png(img, filename, claw::graphic::png::writer::options::best_speed,
           claw::graphic::png::writer::options::none);
